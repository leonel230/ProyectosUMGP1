...
public class RegistroCursos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Registro Cursos");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            PreparedStatement pst = cn.prepareStatement("insert into cursos values(?,?,?)");//Inserta los datos en la tabla clientes2
           
            pst.setString(1, txtcarnet.getText().trim());//Codigo curso
            pst.setString(2, txtnombre.getText().trim());//Nombre curso
            pst.setString(3, txtstatus.getText().trim());//Estado del curso
            pst.executeUpdate();
