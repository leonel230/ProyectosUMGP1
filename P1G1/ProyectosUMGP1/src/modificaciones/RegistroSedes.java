 ...
 * @author Luis Lee
 */
public class RegistroSedes extends javax.swing.JInternalFrame {

    /**
     * Creates new form Registro
     */
    public RegistroSedes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Registrar Sede");
        ...
        jLabel7.setText("Registro Sedes");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            PreparedStatement pst = cn.prepareStatement("insert into sedes values(?,?,?)");//Inserta los datos en la tabla clientes2
           
            pst.setString(1, Codigo_sede.getText().trim());//Carnet
            pst.setString(2, Nombre_sede.getText().trim());//Nombre y apellido
            pst.setString(3, status_sede.getText().trim());//Estado del estudiante
            pst.executeUpdate();
